...
public:
    Menu()
        : _menuIsOpen(true), _gameMode(GameMode::NONE)
    {
    ...
    void drawMenu(sf::RenderWindow& window)
    {
        ...
        singlePlayKeySprite.setPosition(810, 800);
        ...
        while (_menuIsOpen)
        {
            ...
            if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
            {
                if (menuNum == 1) {
                    while (true) {
                        if (drawSecondPageMenu(window) == false) {
                            break;
                        }
                    }
                }
    ...
    bool drawSecondPageMenu(sf::RenderWindow& window)
    {
    ...
    void drawSettingsPageMenu(sf::RenderWindow& window)
    {
        ...
        //auto parameters = readParametersFromFile("players.txt");
...
private:
    ...
    PacmanColors _secondPlayerColor;
    PacmanControls _firstPlayerControls;
    PacmanControls _secondPlayerControls;
